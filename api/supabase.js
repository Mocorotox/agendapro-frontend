// api/supabase.js — Cliente Supabase compartido para AgendaPro
// Se importa en login.html y dashboard.html
...
// Se asume que supabase-js v2 se carga por CDN antes de este archivo:
// <script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script>
const sb = window.supabase.createClient(SUPABASE_URL, SUPABASE_ANON_KEY);

// ── Devuelve el tenant del usuario logueado, o null ──
